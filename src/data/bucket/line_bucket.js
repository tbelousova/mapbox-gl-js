...
class LineBucket implements Bucket {
    ...
    addFeature(feature: LineFeature, geometry: Array<Array<Point>>, imagePositions: {[string]: ImagePosition}) {
        ...
        for (const line of geometry) {
            this.addLine(line, feature, join, cap, miterLimit, roundLimit, imagePositions);
        }
    }

    addLine(vertices: Array<Point>, feature: LineFeature, join: string, cap: string, miterLimit: number, roundLimit: number, imagePositions: {[string]: ImagePosition}) {
        ...
        this.programConfigurations.populatePaintArrays(this.layoutVertexArray.length, feature, imagePositions);
    }
